...
for(i in 1:length(lake_sites$field_site_id)) {  
  ...
  forecasted_temperature <- param.df$beta1 + param.df$beta2 * noaa_future_site$air_temperature     + param.df$beta3 * noaa_future_site$air_temperature + rnorm(31, mean = 0, sd = sigma)
