...
for(i in 1:length(lake_sites$field_site_id)) {  
  ...
  forecasted_temperature <- param.df$beta1 + param.df$beta2 * site_drivers$air_temperature     +   param.df$beta3 * site_drivers$air_temperature^2 + rnorm(31, mean = 0, sd = sigma)
